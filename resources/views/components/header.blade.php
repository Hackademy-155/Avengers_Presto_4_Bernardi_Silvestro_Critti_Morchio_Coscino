        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5">
                <div class="intro-excerpt">
                    <h1 style="font-family: 'Parkinsans'">THE PLACE WHERE YOU CAN BUY <span class="text-decoration-underline">EVERYTHING</span></h1>
                    ...
                    <a href="{{route('article.index')}}" class="text-decoration-none media-btn">
                        <button class="button-main rounded-pill">Explore</button>
                    </a>                    
                </div>
            </div>
            <div class="col-lg-7">
