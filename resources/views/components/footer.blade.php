                ...
                <div class="footer-menu">
                    ...
                    <ul class="wrapper social-icons my-3">
                        ...
                        <li class="icon twitter">
                            <a href="https://x.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoiaXQifQ%3D%3D%22%7D"><i class="bi bi-twitter"></i></a>
                        </li>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div>
                    ...
                    <ul class="list-unstyled text-uppercase fs-6">
                        <li><a href="{{ route('homepage') }}" class="footer-links">Home</a></li>
                        <li><a href="#" class="footer-links">About</a></li>
                        <li><a href="#" class="footer-links">Products</a></li>
                        <li><a href="#" class="footer-links">Contact</a></li>
                        <li><a href="#" class="footer-links">Insert Article</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-4">
