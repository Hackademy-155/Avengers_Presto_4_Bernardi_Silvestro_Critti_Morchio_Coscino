                ...
                <form class="form m-0" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex-row">
                        <button class="btn google rounded-pill">
                            <a
                                href="https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Faccounts.google.com%2F&followup=https%3A%2F%2Faccounts.google.com%2F&passive=1209600&ifkv=AcMMx-ch6eWc6VgPLO6R853hiJlul5VWmB98U3DFSCCgqAEuddfZGGp75biddZ_Yw05tpw2JRlfi&ddm=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin">
                        ...
                        <button class="btn apple rounded-pill">
